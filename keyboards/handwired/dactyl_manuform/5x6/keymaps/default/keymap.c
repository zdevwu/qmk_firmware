...
#define _LOWER 1
#define _RAISE 2
#define _WINDOW_SWITCH 3

#define RAISE MO(_RAISE)
#define LOWER MO(_LOWER)
#define WIN_ALT LM(_WINDOW_SWITCH, MOD_LALT)
  ...
  [_QWERTY] = LAYOUT_5x6(
     ...
     KC_LCTL, KC_Z  , KC_X  , KC_C  , KC_V  , KC_B  ,                         KC_N  , KC_M  ,KC_COMM,KC_DOT ,KC_SLSH,KC_BSLASH,
                      KC_LBRC,KC_RBRC,                                                       KC_BSPC, KC_DEL,
                                      KC_SPC,                                         KC_ENT,
                                      KC_HOME, RAISE,                        KC_RCTL, KC_END,
                                      WIN_ALT, LOWER,                        KC_LGUI, KC_TAB
  ),

  [_LOWER] = LAYOUT_5x6(

     KC_TILD,KC_EXLM, KC_AT ,KC_HASH,KC_DLR ,KC_PERC,                        KC_CIRC,KC_AMPR,KC_ASTR,KC_LPRN,KC_RPRN,_______,
     _______,_______,_______,_______,_______,KC_PGUP,                        _______, KC_P7 , KC_P8 , KC_P9 ,KC_PLUS,_______,
     _______,_______,KC_MPRV,KC_MPLY,KC_MNXT,KC_PGDN,                        _______, KC_P4 , KC_P5 , KC_P6 ,KC_MINS,_______,
